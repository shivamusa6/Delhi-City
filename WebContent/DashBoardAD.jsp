                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-2">
                          ...
                          <div id="apDiv2">
                            ...
                            <div id="text1" style="position:absolute; overflow:hidden; left:12px; top:3px; width:157px; height:30px; z-index:1">
  <div class="wpmd">
  
<div><font face="Georgia" class="ws14"><a href="index.html">Hotels  Task </a></font></div>
</div></div>

<div id="text2" style="position:absolute; overflow:hidden; left:12px; top:39px; width:154px; height:30px; z-index:2">
<div class="wpmd">
<div><font face="Georgia" class="ws14"><a href="index.html">Hospital Task</a></font></div>
</div></div>
<div id="text3" style="position:absolute; overflow:hidden; left:14px; top:75px; width:153px; height:31px; z-index:6">
  <div class="wpmd">
    <div><font face="Georgia" class="ws14"><a href="index.html">Visit palace Task</a>
    </font></div>
  </div>
