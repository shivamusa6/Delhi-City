                        ...
                        <div class="col-md-8 col-sm-6 col-xs-2">
                            <div class="main-menu">
                                <ul class="visible-lg visible-md">
                                    ...
                                    <li><a href="ServicesLogin.jsp">Services</a></li>
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-6 map-wrapper">
                        ...
                        <div class="contact-infos">
                            <ul>
                                ...
                                <li>New DelhiYangon 10620, Myanmar</li>
                                <li>Tel: 010-020-0340</li>
                                <li>Email: <a href="mailto:raja@gmail.com">info@company.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5 col-sm-6">
                        ...
                        <div class="contact-form">
                            <form name="contactform" id="contactform" action="SaveQuery" method="post">
                                <p>
